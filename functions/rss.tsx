  ...
  return (
    <entry>
      ...
      <link
        rel="alternate"
        type="text/html"
        href={`https://ku-tech.netlify.app/${id}`}
      />
  ...
  return (
    <feed xmlns="http://www.w3.org/2005/Atom" xml:lang="ja">
      ...
      <link
        rel="alternate"
        type="text/html"
        href="http://ku-tech.netlify.app/feed/"
      />
      <link
        rel="self"
        type="application/atom+xml"
        href="https://ku-tech.netlify.app/.netlify/functions/rss"
      />
      {entries.map((it) => (
        <Entry
          id={it.id}
...
export const handler = async () => {
  try {
    const results: any = await fetch(
      `https://ku-tech.microcms.io/api/v1/blogs`,
      {
        headers: {
